...
const LANGUAGE_KEYWORDS: Record<string, Set<string>> = {
  typescript: new Set([
    ...
    'class', 'interface', 'type', 'enum', 'import', 'export', 'from', 'default', 'new', 'this',
    'extends', 'implements', 'private', 'public', 'protected', 'static', 'readonly', 'typeof',
    'instanceof', 'switch', 'case', 'break', 'continue', 'try', 'catch', 'finally', 'throw',
    'yield', 'void', 'null', 'undefined', 'true', 'false', 'as', 'in', 'of', 'declare', 'namespace',
  ]),
  javascript: new Set([
    'const', 'let', 'var', 'function', 'async', 'await', 'return', 'if', 'else', 'for', 'while',
    'class', 'import', 'export', 'from', 'default', 'new', 'this', 'extends', 'switch', 'case',
    'break', 'continue', 'try', 'catch', 'finally', 'throw', 'yield', 'void', 'null', 'undefined',
    'true', 'false', 'of',
  ]),
  python: new Set([
    'def', 'class', 'import', 'from', 'as', 'return', 'if', 'elif', 'else', 'for', 'while',
    'try', 'except', 'finally', 'raise', 'with', 'yield', 'lambda', 'pass', 'break', 'continue',
    'and', 'or', 'not', 'is', 'in', 'True', 'False', 'None', 'async', 'await', 'self',
  ]),
  rust: new Set([
    'fn', 'let', 'mut', 'const', 'static', 'struct', 'enum', 'impl', 'trait', 'pub', 'priv',
    'use', 'mod', 'crate', 'self', 'super', 'return', 'if', 'else', 'for', 'while', 'loop',
    'match', 'break', 'continue', 'async', 'await', 'move', 'ref', 'where', 'type', 'dyn',
  ...
  go: new Set([
    ...
    'go', 'select', 'fallthrough', 'true', 'false', 'nil', 'make', 'append',
  ]),
  java: new Set([
    'public', 'private', 'protected', 'static', 'final', 'abstract', 'class', 'interface',
    'extends', 'implements', 'import', 'package', 'return', 'if', 'else', 'for', 'while',
    'do', 'switch', 'case', 'break', 'continue', 'try', 'catch', 'finally', 'throw', 'throws',
    'new', 'this', 'super', 'void', 'int', 'long', 'double', 'float', 'boolean', 'char', 'byte',
...
export function highlightCode(code: string, language: string = 'typescript', theme: Theme = defaultTheme): string {
